...
class Policy:
    ...
    def __init__(self, discount:float = 1):
        ...
        self.actions_list2_greedy = [[0.025, 0.925, 0.025, 0.025], [0.025, 0.925, 0.025, 0.025],
                                     [0.025, 0.925, 0.025, 0.025], [0, 0, 0, 0],
                                     [0.925, 0.025, 0.025, 0.025], [0.925, 0.025, 0.025, 0.025],
                                     [0.925, 0.025, 0.025, 0.025], [0.925, 0.025, 0.025, 0.025],
                                     [0.925, 0.025, 0.025, 0.025], [0.925, 0.025, 0.025, 0.025],
                                     [0.025, 0.025, 0.025, 0.925], [0.025, 0.025, 0.025, 0.925],
                                     [0, 0, 0, 0], [0.925, 0.025, 0.025, 0.025], [0.925, 0.025, 0.025, 0.025],
    ...
    def random_policy(self):
        for i in range(4):
            for j in range(4):
                ...
                self.actions_list[i][j] = random.choice(actions) if self.actions_list[i][j] == 0 else \
                self.actions_list[i][j]
